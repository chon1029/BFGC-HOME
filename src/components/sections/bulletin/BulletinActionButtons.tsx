 ...
 * - 관리자 전용
 * - 호버 시 표시
 * - 설교/일용할 양식과 동일한 디자인 패턴
 */
export default function BulletinActionButtons({ bulletinId, bulletinTitle, onEdit, onDelete }: BulletinActionButtonsProps) {
    return (
            ...
            <AlertDialog>
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            "{bulletinTitle}" 주보가 영구적으로 삭제됩니다.<br />
                            이 작업은 되돌릴 수 없습니다.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
